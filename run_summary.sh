...
for type in "${blast_types[@]}"; do
  ...
  # 执行blast-summary命令
  blast-summary -i ./data/good/${type}/${type}_example.txt -o ./output/good/${type}_good_out_report.md

  blast-summary -i ./data/worse/${type}/${type}_worse_example.txt -o ./output/worse/${type}_worse_out_report.md
